  ...
  <div class="patent-list">
    ...
    <el-form :model="formData"
        ...
        <el-button type="primary"
                   ...
                   @click="pctInCountryApp">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  setup(_, context) {
    ...
    options.query = computed(() => ({
      ...state.filter,
      applicationType: applyType.value.PCTINCOUNTRY,
    }));

    const {
      postData: pctInCountry,
      loading: submitLoading,
    } = useHttp('/patent-corp_api/patents/pct-in-country');
    ...
    // 发起PCT国际申请
    const pctInCountryApp = () => {
      console.info(state.multipleSelection);
      $confirm('是否确认发起PCT进国家申请', '提示', {
